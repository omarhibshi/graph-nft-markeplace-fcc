...
export class ItemPriceUpdated extends ethereum.Event {
  get params(): ItemPriceUpdated__Params {
    return new ItemPriceUpdated__Params(this);
  }
}

export class ItemPriceUpdated__Params {
  _event: ItemPriceUpdated;

  constructor(event: ItemPriceUpdated) {
    this._event = event;
  }
...
export class ProceedAmountWithdrawn extends ethereum.Event {
  get params(): ProceedAmountWithdrawn__Params {
    return new ProceedAmountWithdrawn__Params(this);
  }
}

export class ProceedAmountWithdrawn__Params {
  _event: ProceedAmountWithdrawn;

  constructor(event: ProceedAmountWithdrawn) {
    this._event = event;
  }
