...
import {
    ...
    ItemCanceled as ItemCancelEvent,
...
export function handleItemBought(event: ItemBoughtEvent): void {
    ...
    if (!itemBought) {
        ...
        // Whenever an item is bought, we don't delete this item from ActiveItem table but we just update buyer's address
...
export function handleItemCanceled(event: ItemCancelEvent): void {
